...
> GitHub [0.9.1u-SNAPSHOT](https://github.com/StanleyProjects/Useless.Java.Lib/releases/tag/0.9.1u-SNAPSHOT) release
>
> Maven [metadata](https://central.sonatype.com/repository/maven-snapshots/com/github/kepocnhh/Useless.Java.Lib/maven-metadata.xml)
...
dependencies {
    implementation("com.github.kepocnhh:Useless.Java.Lib:0.9.1u-SNAPSHOT")
}
```
